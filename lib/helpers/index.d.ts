...
export declare const helpers: {
    ...
    logger: {
        error: (log: string | import("./loggerHandler").LogT) => import("winston").Logger;
        warn: (log: string | import("./loggerHandler").LogT) => import("winston").Logger;
        info: (log: string | import("./loggerHandler").LogT) => import("winston").Logger;
        verbose: (log: string | import("./loggerHandler").LogT) => import("winston").Logger;
        debug: (log: string | import("./loggerHandler").LogT) => import("winston").Logger;
    };
    loggerHandler: import("./loggerHandler").LoggerHandlerT;
    makeRequest: import("./makeRequest").MakeRequestT;
    requestHandler: import("./requestHandler").SetupAxiosDefaultT;
    winstonLogConsole: import("winston").Logger;
};
