...
const handleLogProperties = require("../lib/common/handleLogProperties");

mocha.describe("handleLogProperties tests", () => {
  mocha.it(
    "should return cpf,cnpj,cpf_cnpj encrypted when has cpf,cnpj,cpf_cnpj property",
    () => {
      const obj = {
        body: {
          cpf: "12345678912",
  ...
  mocha.it(
    "should return cpf encrypted when has cpf and empty property",
    () => {
      const obj = {
        body: {
          cpf: "12345678912",
